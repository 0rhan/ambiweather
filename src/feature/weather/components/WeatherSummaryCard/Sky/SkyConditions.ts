import {
  ...
  SMOKE,
  THUNDERSTORM,
} from "types/weatherConditions/conditionDescriptions";
import { WEATHER_CONDITION_MAPS } from "types/weatherConditions/weatherConditionCodes";
import {
  SkyClearDay,
  SkyCloudy,
  SkyDrizzle,
...
} from "components/DataDisplay/Icons/WeatherSkyIcons";
