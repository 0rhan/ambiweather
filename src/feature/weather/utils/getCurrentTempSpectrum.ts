import {TEMP_SPECTRUM_COLD, TEMP_SPECTRUM_ZERO, TEMP_SPECTRUM_CHILLY, TEMP_SPECTRUM_WARMLY, TEMP_SPECTRUM_HOT} from "config"
import {tempSpectrumStrings} from "feature/weather/types"
